...
#include "components/kinetix/zenith_hud.h" // ZenithTee v1.1: Spectator list / Array list / Admin Alarm overlay
...
public:
        ...
        CZenithHud m_ZenithHud; // ZenithTee v1.1: Spectator list / Array list / Admin Alarm overlay
