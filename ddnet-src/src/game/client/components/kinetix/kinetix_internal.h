...
//                   3=LaserUnfreeze 4=Pathfinder 5=ESP 6=TAS 7=ServerAim
...
case KX_LINE_SERVER_AIM: enabled = g_Config.m_KxLineServerAimRainbow != 0; speed = g_Config.m_KxLineServerAimRainbowSpeed; break;
                }
...
case KX_LINE_SERVER_AIM: return g_Config.m_KxLineServerAimSize;
        }
...
case KX_LINE_SERVER_AIM: rainbow = g_Config.m_KxLineServerAimRainbow != 0; speed = g_Config.m_KxLineServerAimRainbowSpeed; break;
        }
        if(rainbow)
        {
...
case KX_LINE_SERVER_AIM: return g_Config.m_KxLineServerAimColor;
        }
...
case KX_LINE_SERVER_AIM: return (float)g_Config.m_KxLineServerAimAlpha / 100.0f;
        }
...
inline unsigned KxLineColorAt(EKxLineComponent c, int segment_index)
{
        ...
        case KX_LINE_TAS:
                ...
                break;
case KX_LINE_SERVER_AIM:
                rainbow = g_Config.m_KxLineServerAimRainbow != 0;
                gradient = g_Config.m_KxLineServerAimGradient != 0;
                step = g_Config.m_KxLineServerAimGradientStep;
                break;
        }
