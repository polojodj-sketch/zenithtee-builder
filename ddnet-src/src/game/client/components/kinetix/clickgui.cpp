// (c) ZenithTee. ClickGUI overlay component — see clickgui.h for overview.
//
...
// v1.56.176: ZenithTee client version string (shown in Info panel).
// Bumped manually per release. Matches the commit-message version scheme.
#define ZENITH_VERSION "v1.0"
...
// ZenithTee v1.1: AimBot modes: Edge/Trigger/Always/Smooth (Silent is now a separate toggle).
...
// ZenithTee v1.1: AimBot expandable — now 17 children (added Silent toggle + Smooth slider).
static SRow g_AimBotChildren[] = {
        ...
        {ERowType::Toggle, "Predict", nullptr, false, false, 0, 0, 0, 0, nullptr, nullptr, nullptr, nullptr, 0, 0, nullptr, 0},
        // ZenithTee v1.1: separate Silent toggle (aim is sent to server without moving visible crosshair).
        {ERowType::Toggle, "AB Silent", nullptr, false, false, 0, 0, 0, 0, nullptr, nullptr, nullptr, nullptr, 0, 0, nullptr, 0},
        // ZenithTee v1.1: Aim Mode now has 4 options (Edge/Trigger/Always/Smooth).
        {ERowType::Dropdown, "AB Aim Mode", nullptr, false, false, 0, 0, 0, 0, nullptr, nullptr, nullptr, g_ABAimModeOpts, 4, 0, nullptr, 0},
        // ZenithTee v1.1: Smooth mode interpolation factor (only applies when Aim Mode = Smooth).
        {ERowType::Slider, "AB Smooth", nullptr, false, false, 0.05f, 1.0f, 0.05f, 0.5f, "", nullptr, nullptr, nullptr, 0, 0, nullptr, 0},
...
static SRow g_BlockChildren[] = {
        ...
        // ZenithTee v1.1: Block Predict Aim — aim at the predicted future position of moving targets.
        {ERowType::Toggle, "Predict Aim", nullptr, false, false, 0, 0, 0, 0, nullptr, nullptr, nullptr, nullptr, 0, 0, nullptr, 0},
...
static SRow g_FunctionsRows[] = {
        ...
        {ERowType::Expandable, "Block", nullptr, false, false, 0, 0, 0, 0, nullptr, nullptr, nullptr, nullptr, 0, 0, g_BlockChildren, 38},
        ...
        {ERowType::Expandable, "AimBot", nullptr, false, false, 0, 0, 0, 0, nullptr, nullptr, nullptr, nullptr, 0, 0, g_AimBotChildren, 19},
        ...
        // ZenithTee v1.1: BalanceBot / HookRide / JetRide — FlyRide-pattern dummy controls.
        {ERowType::Toggle, "BalanceBot", nullptr, false, false, 0, 0, 0, 0, nullptr, nullptr, nullptr, nullptr, 0, 0, nullptr, 0},
        {ERowType::Toggle, "HookRide", nullptr, false, false, 0, 0, 0, 0, nullptr, nullptr, nullptr, nullptr, 0, 0, nullptr, 0},
        {ERowType::Toggle, "JetRide", nullptr, false, false, 0, 0, 0, 0, nullptr, nullptr, nullptr, nullptr, 0, 0, nullptr, 0},
        {ERowType::Toggle, "Mirror", nullptr, false, false, 0, 0, 0, 0, nullptr, nullptr, nullptr, nullptr, 0, 0, nullptr, 0},
        {ERowType::Slider, "Jump delay", nullptr, false, false, 5.0f, 100.0f, 1.0f, 20.0f, "t", nullptr, nullptr, nullptr, 0, 0, nullptr, 0},
...
// "Fake Aim" expandable.
// ZenithTee v1.1: added Chaos + Real modes and the Distance slider.
...
static SRow g_FakeAimChildren[] = {
        ...
        {ERowType::Slider, "Distance", nullptr, false, false, 10.0f, 1000.0f, 10.0f, 200.0f, "px", nullptr, nullptr, nullptr, 0, 0, nullptr, 0},
        {ERowType::Toggle, "Show for me", nullptr, false, false, 0, 0, 0, 0, nullptr, nullptr, nullptr, nullptr, 0, 0, nullptr, 0},
        // ZenithTee v1.1: draw a line showing the server-side (spoofed) aim.
        {ERowType::Toggle, "Show server aim", nullptr, false, false, 0, 0, 0, 0, nullptr, nullptr, nullptr, nullptr, 0, 0, nullptr, 0},
};
...
static SRow g_EspChildren[] = {
        ...
        {ERowType::Input, "Targets IDs", nullptr, false, false, 0, 0, 0, 0, nullptr, "", "1,2,3...", nullptr, 0, 0, nullptr, 0},
        // ZenithTee v1.1: ESP boxes + hitboxes.
        {ERowType::Toggle, "ESP Box", nullptr, false, false, 0, 0, 0, 0, nullptr, nullptr, nullptr, nullptr, 0, 0, nullptr, 0},
        {ERowType::Toggle, "ESP Hitboxes", nullptr, false, false, 0, 0, 0, 0, nullptr, nullptr, nullptr, nullptr, 0, 0, nullptr, 0},
};
...
static SRow g_AdvancedRows[] = {
        // ZenithTee v1.1: Zoom Hack + Admin Alarm + HUD toggles.
        ...
        {ERowType::Expandable, "Fake Aim", nullptr, false, false, 0, 0, 0, 0, nullptr, nullptr, nullptr, nullptr, 0, 0, g_FakeAimChildren, 5},
        {ERowType::Expandable, "ESP", nullptr, false, false, 0, 0, 0, 0, nullptr, nullptr, nullptr, nullptr, 0, 0, g_EspChildren, 14},
...
static const char *const g_LineComponentOpts[] = {"AimBot", "TriggerBot", "Trajectory", "Laser Unfreeze", "Pathfinder", "ESP", "TAS", "Server Aim"};
static SRow g_LineRenderingChildren[] = {
        {ERowType::Dropdown, "Component", nullptr, false, false, 0, 0, 0, 0, nullptr, nullptr, nullptr, g_LineComponentOpts, 8, 0, nullptr, 0},
...
static constexpr int INFO_ROW_ZENITH = 4;
...
static SRow g_InfoRows[] = {
        ...
        {ERowType::Label, "ZenithTee Version: " ZENITH_VERSION, nullptr, false, false, 0, 0, 0, 0, nullptr, nullptr, nullptr, nullptr, 0, 0, nullptr, 0},
...
static SPanel g_Panels[NUM_PANELS] = {
        ...
        {"Visuals", g_AdvancedRows, sizeof(g_AdvancedRows) / sizeof(g_AdvancedRows[0])},
...
void CClickGui::OnRender()
{
        ...
        if(isOpen && !m_WasOpen)
        {
				...
				else if(str_comp(row.pName, "Fake Aim") == 0 && str_comp(g_Panels[p].pTitle, "Visuals") == 0)
					row.on = g_Config.m_KxFakeAim != 0;
                                else if(str_comp(row.pName, "ESP") == 0)
                                        row.on = g_Config.m_KxEsp != 0;
                                // ZenithTee v1.1: Zoom Hack toggle sync.
                                ...
                                else if(str_comp(row.pName, "BalanceBot") == 0)
                                        row.on = g_Config.m_KxBalanceBot != 0;
                                else if(str_comp(row.pName, "HookRide") == 0)
                                        row.on = g_Config.m_KxHookRide != 0;
                                else if(str_comp(row.pName, "JetRide") == 0)
                                        row.on = g_Config.m_KxJetRide != 0;
                                else if(str_comp(row.pName, "Mirror") == 0)
                                        row.on = g_Config.m_KxBalanceBotMirror != 0;
                                else if(str_comp(row.pName, "Jump delay") == 0)
                                        row.value = (float)g_Config.m_KxJetRideDelay;
...
if(str_comp(row.pName, "Smart dummy switch") == 0 && !BindsChildVisible(row.pChildren, row.childCount, c))
        continue;
						...
						child.valueIdx = g_Config.m_KxFakeAimMode;
                                        ...
                                        // ZenithTee v1.1: Distance from center slider.
                                        else if(str_comp(child.pName, "Distance") == 0 && str_comp(row.pName, "Fake Aim") == 0)
                                                child.value = (float)g_Config.m_KxFakeAimDist;
                                        // ZenithTee v1.1: server-side aim line toggle sync.
                                        else if(str_comp(child.pName, "Show server aim") == 0)
                                                child.on = g_Config.m_KxFakeAimShowServer != 0;
                                        ...
                                        // ZenithTee v1.1: ESP boxes + hitboxes.
                                        else if(str_comp(child.pName, "ESP Box") == 0)
                                                child.on = g_Config.m_KxEspBox != 0;
                                        else if(str_comp(child.pName, "ESP Hitboxes") == 0)
                                                child.on = g_Config.m_KxEspHitboxes != 0;
                        ...
                        for(int r = 0; r < g_Panels[p].rowCount; ++r)
                        {
                                ...
                                if(str_comp(row.pName, "AimBot") == 0)
                                {
                                        ...
                                        for(int c = 0; c < row.childCount; ++c)
                                        {
                                                ...
                                                // ZenithTee v1.1: Silent toggle + Smooth slider.
                                                else if(str_comp(ch.pName, "AB Silent") == 0)
                                                        ch.on = s.m_Silent;
                                                else if(str_comp(ch.pName, "AB Smooth") == 0)
                                                        ch.value = s.m_Smooth;
                        ...
                        for(int r = 0; r < g_Panels[p].rowCount; ++r)
                        {
                                ...
                                if(str_comp(row.pName, "Block") == 0)
                                {
                                        ...
                                        for(int c = 0; c < row.childCount; ++c)
                                        {
                                                ...
                                                else if(str_comp(ch.pName, "Predict Aim") == 0) ch.on = g_Config.m_KxBlockPredict != 0;
                ...
                for(int r = 0; r < g_Panels[p].rowCount; ++r)
                {
                        ...
                        else if(p == 4 && row.type == ERowType::Input)
                        {
                                if(!m_InputEditing || m_InputPanel != p || m_InputRow != r)
                                {
                                        ...
                                        else if(str_comp(row.pName, "Avoid Freeze") == 0) pCmd = "toggle kx_avoid_freeze_bot 1 0";
...
case KX_LINE_SERVER_AIM: child.on = g_Config.m_KxLineServerAimRainbow != 0; break;
                                                }
                                        }
...
case KX_LINE_SERVER_AIM: child.value = (float)g_Config.m_KxLineServerAimRainbowSpeed / 10.0f; break;
                                                }
                                        }
...
case KX_LINE_SERVER_AIM: child.on = g_Config.m_KxLineServerAimGradient != 0; break;
                                                }
                                        }
...
case KX_LINE_SERVER_AIM: child.value = (float)g_Config.m_KxLineServerAimGradientStep; break;
                                                }
                                        }
...
case KX_LINE_SERVER_AIM: g_Config.m_KxLineServerAimRainbowSpeed = rawVal; break;
                                }
                        }
...
case KX_LINE_SERVER_AIM: g_Config.m_KxLineServerAimGradientStep = rawVal; break;
                                }
                        }
...
case KX_LINE_SERVER_AIM: g_Config.m_KxLineServerAimSize = (int)pTarget->value; break;
                                        }
                                        }
                                else // Line opacity
                                        {
...
case KX_LINE_SERVER_AIM: g_Config.m_KxLineServerAimAlpha = (int)pTarget->value; break;
                                        }
                                        }
                        }
                        ...
                        // ZenithTee v1.1: Fake Aim distance from center.
                        else if(str_comp(pTarget->pName, "Distance") == 0)
                                g_Config.m_KxFakeAimDist = (int)pTarget->value;
                        // ZenithTee v1.1: JetRide jump interval.
                        else if(str_comp(pTarget->pName, "Jump delay") == 0)
                                g_Config.m_KxJetRideDelay = (int)pTarget->value;
                                ...
                                if(m_DragSliderRow >= 0 && m_DragSliderRow < dragPanel.rowCount)
                                {
                                        ...
                                        if(str_comp(parentRow.pName, "AimBot") == 0)
                                        {
                                                ...
                                                if(w >= 0 && w < CAimBot::NUM_WEAPONS_AIM)
                                                {
                                                    ...
                                                    // ZenithTee v1.1: Smooth mode interpolation factor.
                                                    else if(str_comp(pTarget->pName, "AB Smooth") == 0)
                                                        s.m_Smooth = pTarget->value;
                                                }
                                        }
...
void CClickGui::HandleMouseDown(vec2 mousePos)
{
        ...
        for(int idx = 0; idx < NUM_PANELS; ++idx)
        {
                ...
                if(HitTestRow(mousePos, i, outRow, outChild, rx, ry, rw, rh))
                {
					...
					else if(str_comp(pTarget->pName, "Fake Aim") == 0 && str_comp(g_Panels[i].pTitle, "Visuals") == 0)
						g_Config.m_KxFakeAim = pTarget->on ? 1 : 0;
                                        else if(str_comp(pTarget->pName, "ESP") == 0)
                                                g_Config.m_KxEsp = pTarget->on ? 1 : 0;
                                        // ZenithTee v1.1: Zoom Hack toggle.
                                        ...
                                        // ZenithTee v1.1: HUD list toggles.
                                        else if(str_comp(pTarget->pName, "Spectator list") == 0)
                                                g_Config.m_KxSpectatorList = pTarget->on ? 1 : 0;
                                        else if(str_comp(pTarget->pName, "Array list") == 0)
                                                g_Config.m_KxArrayList = pTarget->on ? 1 : 0;
                                        // ZenithTee v1.1: ESP boxes + hitboxes toggles.
                                        else if(str_comp(pTarget->pName, "ESP Box") == 0)
                                                g_Config.m_KxEspBox = pTarget->on ? 1 : 0;
                                        else if(str_comp(pTarget->pName, "ESP Hitboxes") == 0)
                                                g_Config.m_KxEspHitboxes = pTarget->on ? 1 : 0;
                                                ...
                                                g_Config.m_KxAvoidFreezeBot = pTarget->on ? 1 : 0;
                                        // Functions panel — Fly/Copy Moves sub-section
                                        ...
                                        // ZenithTee v1.1: BalanceBot / HookRide / JetRide.
                                        else if(str_comp(pTarget->pName, "BalanceBot") == 0)
                                                g_Config.m_KxBalanceBot = pTarget->on ? 1 : 0;
                                        else if(str_comp(pTarget->pName, "HookRide") == 0)
                                                g_Config.m_KxHookRide = pTarget->on ? 1 : 0;
                                        else if(str_comp(pTarget->pName, "JetRide") == 0)
                                                g_Config.m_KxJetRide = pTarget->on ? 1 : 0;
                                        else if(str_comp(pTarget->pName, "Mirror") == 0)
                                                g_Config.m_KxBalanceBotMirror = pTarget->on ? 1 : 0;
                                        ...
                                        else if(str_comp(row.pName, "AimBot") == 0)
                                        {
                                                ...
                                                if(w >= 0 && w < CAimBot::NUM_WEAPONS_AIM)
                                                {
                                                        ...
                                                        // ZenithTee v1.1: separate Silent toggle for AimBot.
                                        ...
                                        else if(str_comp(row.pName, "Block") == 0 && pTarget != &row)
                                        {
                                                ...
                                                else if(str_comp(pTarget->pName, "Predict Aim") == 0) g_Config.m_KxBlockPredict = pTarget->on ? 1 : 0;
...
case KX_LINE_SERVER_AIM: g_Config.m_KxLineServerAimRainbow = pTarget->on ? 1 : 0; break;
                                                }
                                        }
...
case KX_LINE_SERVER_AIM: g_Config.m_KxLineServerAimGradient = pTarget->on ? 1 : 0; break;
                                                }
                                        }
                                        return;
                                }
		...
		if(str_comp(panel.pTitle, "TAS") == 0 && !TasRowVisible(panel.pRows, panel.rowCount, r))
			continue;
                ...
                if(r == m_DropdownRow && m_DropdownChild < 0)
                {
					...
					else if(str_comp(target.pName, "Mode") == 0 && str_comp(panel.pTitle, "Visuals") == 0)
...
if(str_comp(row.pName, "Smart dummy switch") == 0 && !BindsChildVisible(row.pChildren, row.childCount, c))
        continue;
							...
							else if(str_comp(target.pName, "Mode") == 0 && str_comp(row.pName, "Fake Aim") == 0 && str_comp(panel.pTitle, "Visuals") == 0)
								g_Config.m_KxFakeAimMode = o;
                                                        // ESP dropdowns
                                                        else if(str_comp(target.pName, "ESP Team") == 0)
                                                                g_Config.m_KxEspTeamFilter = o;
...
case KX_LINE_SERVER_AIM: g_Config.m_KxLineServerAimColor = 0xff000000u | (hex & 0xffffff); break;
                        }
                }
        }
        ...
        else if(m_InputPanel == 4 && pRow->type == ERowType::Input)
        {
                ...
                else if(str_comp(pRow->pName, "Avoid Freeze") == 0) pCmd = "toggle kx_avoid_freeze_bot 1 0";
