...
public:
        ...
        // ZenithTee v1.1: persistent per-type settings. Loaded from
        // "zenithtee_trajectory.cfg" at init, saved debounced on change and
        // on shutdown (same mechanism as CAimBot weapon settings).
        void OnInit() override;
        void OnShutdown() override;
        void LoadSettings();
        void SaveSettings();
        static constexpr const char *SETTINGS_FILENAME = "zenithtee_trajectory.cfg";
private:
        // ZenithTee v1.1: settings persistence state (see OnInit/OnShutdown).
